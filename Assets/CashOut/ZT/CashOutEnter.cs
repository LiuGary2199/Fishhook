...
public class CashOutEnter : MonoBehaviour
{
    ...
    void Start()
    {
        CashOutManager.AgeFletcher()._CashOutEnter = this;
        OpenPanelBtn.onClick.AddListener(() => { UIAwesome.AgeFletcher().DaleUIHobby(nameof(CashOutPanel)); });
        UpdateMoney();
    }
    ...
    public void UpdateMoney()
    {
        ...
        MoneyTextAnim = DOTween.To(() => MoneyStart, x => MoneyText.text = x.ToString("F2"), CashOutManager.AgeFletcher().Money, 1f);
