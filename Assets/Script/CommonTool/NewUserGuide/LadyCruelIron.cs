...
/// 矩形遮罩镂空
/// </summary>
public class LadyCruelIron : MonoBehaviour
{
    public static LadyCruelIron instance;
[UnityEngine.Serialization.FormerlySerializedAs("Hand")]    public GameObject Core;
...
[UnityEngine.Serialization.FormerlySerializedAs("Text")]
    ...
    public void Cape(GameObject _target)
    {
        ...
        else
        {
            ...
            float width = 1;
            float height = 1;
            Support[0] = new Vector3(pos.x - width, pos.y - height);
            Support[1] = new Vector3(pos.x - width, pos.y + height);
            Support[2] = new Vector3(pos.x + width, pos.y + height);
            Support[3] = new Vector3(pos.x + width, pos.y - height);
        }
        //计算高亮显示区域在画布中的范围
